...
def triangle_solver():
            ...
            while have_check == True:
                ...
                if what_have_2 == what_have_1:
                    ...
                    while True:
                        ...
                        # make sure that hypotenuse is the longest side and that program factors in
                        # the order that the sides were given, then calculate answer
    ...
    which_trig.append(trig_function)
